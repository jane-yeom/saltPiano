...
<div id="header">
	<div class="header_inner">
		...
		<div id="menu">
  			<ul class="menu">
				<li><a href="<%=request.getContextPath()%>/admin/sheet/index.do" class="parent"><span>악보관리</span></a>
					<div class="standard_left">
					<ul>
						<li><a href="<%=request.getContextPath()%>/admin/sheet/index.do"><span>인기악보</span></a></li>
						<li><a href="<%=request.getContextPath()%>/admin/sheet2/index.do"><span>무료악보</span></a></li>
					</ul>
					</div>
					</li>
				<li><a href="<%=request.getContextPath()%>/admin/video/index.do" class="parent"><span>동영상관리</span></a>
					<div class="standard_left">
					<ul>
						<li><a href="<%=request.getContextPath()%>/admin/video/index.do"><span>동영상</span></a></li>
						<li><a href="<%=request.getContextPath()%>/admin/tutorial/index.do"><span>tutorial</span></a></li>
					</ul>
					</div>
					</li>
				<li><a href="<%=request.getContextPath()%>/admin/board/notice/index.do" class="parent"><span>게시판관리</span></a>
					<div class="standard_left">
					<ul>
						<li><a href="<%=request.getContextPath()%>/admin/board/notice/index.do"><span>공지사항</span></a></li>
						<li><a href="<%=request.getContextPath()%>/admin/board/reply/index.do"><span>Q&A</span></a></li>
					</ul>
					</div>
				</li>
