...
public class SiteProperty {
	 ...
	 * 업체명
	 */
	public static final String 	COMPANY_NAME			= "Salt Piano";
	/**
	 * 관리자 시작페이지
	 */
	public static final String	INDEX_PAGE				= "/admin/board/notice/index.do";
	/**
	 * 회원 시작페이지
	 */
	public static final String	SALTPIANO_INDEX_PAGE		= "/index.do";
	/**
	 * 보안서버인증서(SSL)사용여부
	 */
...
//	public static final String 	COMPANY_URL_MO			= "http://m.bigbang";
	 ...
	 * 대표 이메일
	 */
	public static final String 	COMPANY_EMAIL			= "janepianoforte@gmail.com";
